...
class CardMeaningFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.card02CV.setOnClickListener {
            val id02 = card02ID
            findNavController().navigate(CardMeaningFragmentDirections.actionCardMeaningFragmentToOneCardFragment(id02))
        }

        binding.card03CV.setOnClickListener {
            val id03 = card03ID
            findNavController().navigate(CardMeaningFragmentDirections.actionCardMeaningFragmentToOneCardFragment(id03))
        }
